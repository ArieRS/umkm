...
class Public_model extends CI_Model
{
    ...
    public function getProducts($limit = null, $start = null, $big_get, $vendor_id = false)
    {
        ...
        $this->db->select('vendors.address as vendor_address, products.id,products.image, products.quantity, products_translations.title, products_translations.price, products_translations.old_price, products.url, vendors.email');
        $this->db->join('products_translations', 'products_translations.for_id = products.id', 'left');
    ...
    public function getOneProduct($id)
    {
        ...
        $this->db->select('vendors.address as vendor_address, products.*, products_translations.title,products_translations.description, products_translations.price, products_translations.old_price, products.url, shop_categories_translations.name as categorie_name,vendors.email');
    ...
    {
        $this->db->select('products.id, products.image, products.url, products_translations.price, products_translations.title, products.quantity');
    ...
    /**
     * @description Users for notification by email
     * @return array
     */
    ...
    {
        $this->db->select('vendors.address as vendor_address, products.id, products.quantity, products.image, products.url, products_translations.price, products_translations.title, products_translations.basic_description, products_translations.old_price');
        $this->db->join('products_translations', 'products_translations.for_id = products.id', 'left');
        $this->db->join('vendors', 'vendors.id = products.vendor_id', 'left');
        $this->db->where('products_translations.abbr', MY_LANGUAGE_ABBR);
        $this->db->where('visibility', 1);
    ...
    {
        $this->db->select('vendors.address as vendor_address, products.id, products.quantity, products.image, products.url, products_translations.price, products_translations.title, products_translations.old_price,vendors.email');
        $this->db->join('products_translations', 'products_translations.for_id = products.id', 'left');
        $this->db->join('vendors', 'vendors.id = products.vendor_id', 'left');
        if ($noId > 0) {
