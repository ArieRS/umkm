    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <div class="row row-info">
                ...
                <div class="col-sm-6"><?= CURRENCY.' '.number_format($product['price'], 2) ?></div>
                <div class="col-sm-12 border-bottom"></div>
            </div>
            <?php if ($product['old_price'] != '') { ?>
                <div class="row row-info">
                    <div class="col-sm-6"><b><?= lang('old_price') ?>:</b></div>
                    <div class="col-sm-6"><?= CURRENCY.' '.number_format($product['old_price'], 2) ?></div>
                    <div class="col-sm-12 border-bottom"></div>
                </div>
            <?php }
            if ($publicQuantity == 1) { ?>
            ...
            <?php
            if ((isset($_SESSION['logged_vendor']) == true) && ($_SESSION['logged_vendor'] == $product['email'])) {
