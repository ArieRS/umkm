            ...
            <div id="content">
                <?php if ($multiVendor == 1) { ?>
                    <div id="top-user-panel">
                        <div class="container">
                            <?php if (isset($_SESSION['logged_vendor'])===false) { ?>
                            ...
                            <?php } else {?>
                                <div class="dropdown dropdown-lg pull-right">
                                    <button class="dropdown-toggle btn-blue-round"
                                                data-toggle="dropdown" aria-expanded="false"><?php if (isset($_SESSION['logged_vendor_name'])==true) echo$_SESSION['logged_vendor_name']; else echo$_SESSION['logged_vendor'];?> <span
                                                    class="caret"></span></button>

                                    <ul class="dropdown-menu dropdown-menu-right dropdown-cart" role="menu">
                                        <a href="<?= LANG_URL . '/vendor/me' ?>" class="btn btn-menuvendor"><?= lang('vendor_dashboard') ?></a>
                                        <a href="<?= LANG_URL . '/vendor/logout' ?>" onclick="clearCart()" class="btn btn-menuvendor"><?= lang('vendor_logout') ?></a>
...
<!--          <div class="item">-->
<!--            --><?php //echo($_SESSION['logged_vendor']);?>
<!--          </div>-->
<!--          <div class="ui divider"></div>-->
