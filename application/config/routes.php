...
// ECOMMERCE GROUP
$route['admin/publishslider'] = "admin/ecommerce/publishslider";
$route['admin/publishslider/(:num)'] = "admin/ecommerce/publishslider/index/$1";
$route['admin/sliderimage'] = "admin/ecommerce/sliderimage";
$route['admin/sliderimage/(:num)'] = "admin/ecommerce/sliderimage/index/$1";
...
$route['admin/verified/products'] = "admin/ecommerce/verifiedproducts";
...
$route['admin/updatePublish/(:num)'] = "admin/ecommerce/publish/updatePublish/$1";
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
