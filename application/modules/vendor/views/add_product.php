            ...
            <form class="form-box" action="" method="POST" enctype="multipart/form-data">
                ...
                foreach ($languages->result() as $language) {
                    ...
                    <div class="form-group">
                        <label><?= lang('vendor_product_name') ?></label>
                ...
                foreach ($languages->result() as $language) {
                    ?>
                    <label><?= lang('vendor_product_description') ?> </label>
                    <div class="form-group">
                ...
                foreach ($languages->result() as $language) {
                    ...
                    <div class="form-group">
                        <img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="" class="language">
                        <label><?= lang('vendor_old_price') ?></label>
                ...
                <?php } ?>
                <div class="form-group">
                    <label><?= lang('vendor_quantity') ?></label>
                    <input type="text" placeholder="1,2,3,dst" name="quantity" value="<?= @$_POST['quantity'] ?>" class="form-control">
                </div>
                <div class="form-group">
                    <label><?= lang('vendor_position') ?></label>
                    <input type="text" placeholder="1,2,3,dst" name="position" value="<?= @$_POST['position'] ?>" class="form-control">
                </div>
