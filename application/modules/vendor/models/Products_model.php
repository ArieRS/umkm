...
class Products_model extends CI_Model
{
    ...
    public function getProducts($limit, $page, $vendor_id)
    {
        ...
        $this->db->where('vendor_id', $vendor_id);
        $query = $this->db->select('products.*, products_translations.title, products_translations.description, products_translations.price,quantity')->get('products', $limit, $page);
        return $query->result();
    }
