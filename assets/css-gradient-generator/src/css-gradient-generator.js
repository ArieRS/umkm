  ...
  function refreshCssOutput() {
    ...
    if (visiblecount > 1) {
      ...
      if (gradientdata.valid) {
        ...
        cssoutput += '.btn-go-search:active,.btn-go-search:focus, .btn-go-search:hover, .button-more:hover, .button-more:focus, .button-more:hover, .btn-menuvendor:active,.btn-menuvendor:focus, .btn-menuvendor:hover { background-color: ' + more_brigness_color + '; }\n';
